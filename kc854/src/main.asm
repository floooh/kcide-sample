...
scroll_text:
    ...
    db "The top model KC85/4 (introduced in 1988) has a 1.77 MHz U880 CPU (an unlicensed Z80 clone), 128 KB RAM and "
    db "20 KB ROM. The display resolution is "
    db "320x256 pixels in 14 foreground- and 8 background-colors with a color resolution of 40x256 "
    db "(e.g. a block of 8x1 pixels shares the same foreground and background color). "
    ...
    db "the KC85 video hardware is not programmable in any way. All rendering and scrolling has to be done "
    db "with the CPU. "
    db "The KC85 computers also don't have a dedicated sound chip like many western home computers, "
    db "instead two Z80 CTC channels can be programmed in timer mode to produce simple square wave audio in stereo at "
